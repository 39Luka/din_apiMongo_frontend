...
For developers and advanced users, we provide a live catalog of examples where different configurations can be tested.

### 1. Bakery Product View
...
The catalog displays products in a grid of cards.

<iframe src="http://localhost:6006/iframe.html?id=components-rendercards--default&viewMode=story" width="100%" height="600"></iframe>
